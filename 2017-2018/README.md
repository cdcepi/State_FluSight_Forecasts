This folders contains state-level forecasts submitted during the 2017-2018 influenza season. Each folder contains submissions from a single forecasting model. Further details about the forecasts are available below. 
